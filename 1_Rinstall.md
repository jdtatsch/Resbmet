...
- software livre
- código fonte aberto
- funciona em diversos sistemas operacionais (Linux, Windows e MacOS)
- asd
...
<a href="http://www.youtube.com/watch?feature=player_embedded&v=lLuc6rtWkrM
" target="_blank"><img src="http://img.youtube.com/vi/lLuc6rtWkrM/0.jpg" 
alt="IMAGE ALT TEXT HERE" width="240" height="180" border="10" /></a>

## O que é o RStudio?
O [RStudio](http://www.rstudio.com/) é um ambiente de desenvolvimento integrado (IDE) para o R e será utilizado no curso. O RStudio oferece um conjunto de ferramentas integradas para tornar a interação com o R mais produtiva. O RStudio inclui:
- console do R
- editor de texto com realce da sintaxe do R que suporta a execução direta de código
- ferramentas para gráficos, majeo do histórico e do espaço de trabalho
